...
public class UserPageController implements Initializable {
    ...
    public void CheckBalance(ActionEvent event) throws SQLException, IOException {
        ...
        while (rs.next()) {
            ...
            loader.setLocation(getClass().getResource("/Resources/fxml/BalancePage.fxml"));
            loader.load();
            Parent root = loader.getRoot();
            BalancePageController bpc = loader.getController();
            bpc.SetBalance(Balance);
            Scene scene = new Scene(root);
            scene.getStylesheets().add("/Resources/styles/BalancePage.css");
            Image icon = new Image("/Resources/icons/DepositPage.png");
    ...
    public void Withdraw(ActionEvent event) throws IOException, SQLException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Resources/fxml/WithdrawPage.fxml"));
        loader.load();
        Parent root = loader.getRoot();
        BalancePageController bpc = loader.getController();
        ...
        bpc.StqWithdrawPage();
        Scene scene = new Scene(root);
        scene.getStylesheets().add("/Resources/styles/WithdrawPage.css");
        Image icon = new Image("/Resources/icons/DepositPage.png");
        stage.getIcons().add(icon);
        stage.setResizable(false);
        stage.sizeToScene();
    ...
    void DepositMoney(ActionEvent event) throws IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Resources/fxml/DepositPage.fxml"));
        loader.load();
        Parent root = loader.getRoot();
        BalancePageController bpc = loader.getController();
        bpc.getUserID(UserID);
        bpc.StqDepositPage();
        Scene scene = new Scene(root);
        scene.getStylesheets().add("/Resources/styles/DepositPage.css");
        Image icon = new Image("/Resources/icons/DepositPage.png");
        stage.getIcons().add(icon);
        stage.setResizable(false);
        stage.sizeToScene();
    ...
    void AccountInfo(ActionEvent event) throws IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Resources/fxml/AccountInfoPage.fxml"));
        loader.load();
        Parent root = loader.getRoot();
        ...
        aic.StqAccountInfo();
        Scene scene = new Scene(root);
        scene.getStylesheets().add("/Resources/styles/AccountInfoPage.css");
        Image icon = new Image("/Resources/icons/usericon4.png");
        stage.getIcons().add(icon);
        stage.setResizable(false);
        stage.sizeToScene();
    ...
    void ChangePassword(ActionEvent event) throws IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Resources/fxml/ChangePassword.fxml"));
        loader.load();
        Parent root = loader.getRoot();
        AccountInfoController aic = loader.getController();
        aic.getUserID(UserID);
        ...
        Scene scene = new Scene(root);
        scene.getStylesheets().add("/Resources/styles/ChangePassword.css");
    ...
    void BalanceTransfer(ActionEvent event) throws IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Resources/fxml/BalanceTransfer.fxml"));
        loader.load();
        Parent root = loader.getRoot();
        BalancePageController bpc = loader.getController();
        bpc.getUserID(UserID);
        ...
        Scene scene = new Scene(root);
        scene.getStylesheets().add("/Resources/styles/BalanceTransfer.css");
        Image icon = new Image("/Resources/icons/DepositPage.png");
        stage.getIcons().add(icon);
        stage.setResizable(false);
        stage.sizeToScene();

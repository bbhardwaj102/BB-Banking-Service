    ...
    private void Login(ActionEvent event) throws SQLException, IOException {
        ...
        if (userrb.isSelected()) {
            ...
            if (rs.next()) {
                ...
                loader.setLocation(getClass().getResource("/Resources/fxml/UserPage.fxml"));
                loader.load();
                Parent root = loader.getRoot();
                UserPageController upc = loader.getController();
                upc.GetUserID(useridtf.getText(), rs.getString("name"));
                stage.setTitle("User Page");
                Image icon = new Image("/Resources/icons/UserPage.png");
                stage.getIcons().add(icon);
                stage.setMinHeight(710);
                stage.setMinWidth(1345);
                stage.setMaximized(true);
                Scene scene = new Scene(root);
                scene.getStylesheets().add("/Resources/styles/UserPage.css");
                stage.setScene(scene);
                stage.show();
                mssg.setText("");
                Media someSound = new Media(getClass().getResource("/Resources/audio/UserLogin.mp3").toString());    
            ...
            if(rs.next()) {
                Stage stage = new Stage();
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(getClass().getResource("/Resources/fxml/AdminPage.fxml"));
                loader.load();
                Parent root = loader.getRoot();
                ...
                stage.getIcons().add(icon);
                Scene scene = new Scene(root);
                scene.getStylesheets().add("/Resources/styles/AdminPage.css");
                stage.setScene(scene);
                stage.show();
                mssg.setText("");
                Media someSound = new Media(getClass().getResource("/Resources/audio/AdminLogin.mp3").toString());    
                MediaPlayer mp = new MediaPlayer(someSound);
                mp.play();
            }
            else{
